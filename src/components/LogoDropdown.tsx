...
export function LogoDropdown() {
  const { isAuthenticated, signOutAll } = useAuth();
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="icon"
          className="h-10 w-10"
          aria-label="NexusPlacement Institutional Portal Logo — open site menu"
        >
          <img
            src={logo}
            alt="NexusPlacement Institutional Portal Logo"
            width={32}
            height={32}
